...
function SalmonCookie(locationName, minCustomers, maxCustomers, avgCookiesPerSale){
...
SalmonCookie.prototype.calcCookiesSoldEachHour = function(){
...
SalmonCookie.prototype.render = function(where){
  var thisStoreList = document.getElementById(where);
  this.calcCookiesSoldEachHour();
  for(var i = 0; i < this.cookiesSoldEachHour.length; i++){
    var liEl = document.createElement('li');
    liEl.textContent = hours[i] + ': ' + this.cookiesSoldEachHour[i] + ' cookies';
    thisStoreList.appendChild(liEl);
  }
  var totalLiEl = document.createElement('li');
  totalLiEl.textContent = 'Total: ' + this.totalCookiesPerDay + ' cookies';
  thisStoreList.appendChild(totalLiEl);
};

new SalmonCookie('pike', 23, 65, 6.3);
new SalmonCookie('seatac', 3, 24, 1.2);
new SalmonCookie('seattlecenter', 11, 38, 3.7);
new SalmonCookie('capitolhill', 20, 38, 2.3);
new SalmonCookie('alki', 2, 16, 4.6);

for(var i = 0; i < this.allLocations.length; i++){
  allLocations[i].render(allLocations[i].locationName);
}

//
// for(var i = 0; i < SalmonCookie.length; i++){
//   console.log(SalmonCookie[i].locationName);
// }
//
// function locationName() {
//   var SalmonCookie =  document.getElementById('locationName');
//   for(var i = 0; i < SalmonCookie.length; i++){
//     var liEl = document.createElement('li');
//     liEl.textContent = SalmonCookie[i].locationName;
//     SalmonCookie.appendChild(liEl);
//   }
// }
